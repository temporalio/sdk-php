...
class WorkflowTestCase extends AbstractFunctional
{
    ...
    public function testEmptyPayload(): void
    {
        ...
        $log = <<<LOG
            ...
            2021/01/12 15:25:13	[97mDEBUG[0m	[{"id":$id1,"command":"ExecuteActivity","options":{"name":"SimpleActivity.empty","options":{"TaskQueueName":null,"ScheduleToCloseTimeout":0,"ScheduleToStartTimeout":0,"StartToCloseTimeout":5000000000,"HeartbeatTimeout":0,"WaitForCancellation":false,"ActivityID":"","RetryPolicy":null,"Priority":{"priority_key":0}}},"payloads":"$emptyPayloadStr","header":""},{"payloads":"ChkKFwoIZW5jb2RpbmcSC2JpbmFyeS9udWxs"}]	{"receive": true}
