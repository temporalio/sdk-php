...
namespace Temporal\Tests\Acceptance\Harness\DataConverter\Fibers\JsonProtobuf;
...
class JsonProtobufTest extends TestCase
{
    ...
    public function check(
        #[Stub('Harness_DataConverter_Fibers_JsonProtobuf', args: [INPUT])]
...
{
    #[WorkflowMethod('Harness_DataConverter_Fibers_JsonProtobuf')]
