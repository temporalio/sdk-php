...
namespace Temporal\Tests\Acceptance\Harness\DataConverter\Fibers\Json;
...
class JsonTest extends TestCase
{
    ...
    public function check(
        #[Stub('Harness_DataConverter_Fibers_Json', args: [EXPECTED_RESULT])]
...
{
    #[WorkflowMethod('Harness_DataConverter_Fibers_Json')]
