...
namespace Temporal\Tests\Acceptance\Harness\DataConverter\Fibers\Empty;
...
class EmptyTest extends TestCase
{
    ...
    public function check(
        #[Stub('Harness_DataConverter_Fibers_Empty')]
...
{
    #[WorkflowMethod('Harness_DataConverter_Fibers_Empty')]
    public function run()
    {
