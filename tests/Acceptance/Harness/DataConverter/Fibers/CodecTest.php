...
namespace Temporal\Tests\Acceptance\Harness\DataConverter\Fibers\Codec;
...
class CodecTest extends TestCase
{
    ...
    public function check(
        #[Stub('Harness_DataConverter_Fibers_Codec', args: [EXPECTED_RESULT])]
        #[Client(
...
{
    #[WorkflowMethod('Harness_DataConverter_Fibers_Codec')]
