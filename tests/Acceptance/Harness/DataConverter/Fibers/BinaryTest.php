...
namespace Temporal\Tests\Acceptance\Harness\DataConverter\Fibers\Binary;
...
class BinaryTest extends TestCase
{
    ...
    public function check(
        #[Stub('Harness_DataConverter_Fibers_Binary', args: [INPUT])]
...
{
    #[WorkflowMethod('Harness_DataConverter_Fibers_Binary')]
