...
namespace Temporal\Tests\Acceptance\Harness\DataConverter\Fibers\BinaryProtobuf;
...
class BinaryProtobufTest extends TestCase
{
    ...
    public function check(
        #[Stub('Harness_DataConverter_Fibers_BinaryProtobuf', args: [INPUT])]
        #[Client(
...
{
    #[WorkflowMethod('Harness_DataConverter_Fibers_BinaryProtobuf')]
