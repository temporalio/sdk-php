...
namespace Temporal\Tests\Acceptance\Harness\EagerWorkflow\Fibers\SuccessfulStart;
...
\define(__NAMESPACE__ . '\\EXPECTED_RESULT', 'Hello World');
...
class SuccessfulStartTest extends TestCase
{
    ...
    public function start(
        #[Stub('Harness_EagerWorkflow_Fibers_SuccessfulStart', eagerStart: true,)]
...
{
    #[WorkflowMethod('Harness_EagerWorkflow_Fibers_SuccessfulStart')]
    public function run()
    {
