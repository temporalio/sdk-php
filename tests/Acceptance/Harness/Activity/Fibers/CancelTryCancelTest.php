...
namespace Temporal\Tests\Acceptance\Harness\Activity\Fibers\CancelTryCancel;
...
{
    #[Test]
    public static function check(#[Stub('Harness_Activity_Fibers_CancelTryCancel')]WorkflowStubInterface $stub): void
    {
...
class FeatureWorkflow
{
    ...
    #[WorkflowMethod('Harness_Activity_Fibers_CancelTryCancel')]
    public function run()
    {
        # Start workflow
    ...
    #[\Temporal\Workflow\SignalMethod('activity_result')]
