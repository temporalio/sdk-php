...
namespace Temporal\Tests\Acceptance\Harness\Signal\Fibers\SignalWithStart;
...
class SignalWithStartTest extends TestCase
{
    ...
    public static function checkSignalToExistingWorkflow(
        #[Stub('Harness_Signal_Fibers_SignalWithStart', args: [-2])] WorkflowStubInterface $stub,
        WorkflowClientInterface $client,
        Feature $feature,
    ): void {
...
class FeatureWorkflow
{
    ...
    #[WorkflowMethod('Harness_Signal_Fibers_SignalWithStart')]
