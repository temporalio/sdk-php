...
namespace Temporal\Tests\Acceptance\Harness\Signal\Fibers\PreventClose;
...
class PreventCloseTest extends TestCase
{
    ...
    public static function checkSignalOutOfExecution(
        #[Stub('Harness_Signal_Fibers_PreventClose')]WorkflowStubInterface $stub,
    ): void {
        $stub->signal('add', 1);
...
class FeatureWorkflow
{
    ...
    #[WorkflowMethod('Harness_Signal_Fibers_PreventClose')]
    public function run()
    {
