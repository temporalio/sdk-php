...
namespace Temporal\Tests\Acceptance\Harness\Schedule\Fibers\Pause;
    ...
    public static function check(
        ...
        $handle = $client->createSchedule(
            schedule: Schedule::new()
                ->withAction(
                    StartWorkflowAction::new('Harness_Schedule_Fibers_Pause')
...
{
    #[WorkflowMethod('Harness_Schedule_Fibers_Pause')]
