...
namespace Temporal\Tests\Acceptance\Harness\Schedule\Fibers\Trigger;
    ...
    public static function check(
        ...
        $handle = $client->createSchedule(
            schedule: Schedule::new()
                ->withAction(StartWorkflowAction::new('Harness_Schedule_Fibers_Trigger')
...
{
    #[WorkflowMethod('Harness_Schedule_Fibers_Trigger')]
