...
namespace Temporal\Tests\Acceptance\Harness\Schedule\Fibers\Backfill;
    ...
    public static function check(
        ...
        $handle = $client->createSchedule(
            schedule: Schedule::new()
                ->withAction(
                    StartWorkflowAction::new('Harness_Schedule_Fibers_Backfill')
...
{
    #[WorkflowMethod('Harness_Schedule_Fibers_Backfill')]
