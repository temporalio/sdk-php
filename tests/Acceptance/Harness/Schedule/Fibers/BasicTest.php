...
namespace Temporal\Tests\Acceptance\Harness\Schedule\Fibers\Basic;
    ...
    public static function check(
        ...
        $handle = $scheduleClient->createSchedule(
            schedule: Schedule::new()
                ->withAction(
                    StartWorkflowAction::new('Harness_Schedule_Fibers_Basic')
...
{
    #[WorkflowMethod('Harness_Schedule_Fibers_Basic')]
