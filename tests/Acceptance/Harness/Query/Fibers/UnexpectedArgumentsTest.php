...
namespace Temporal\Tests\Acceptance\Harness\Query\Fibers\UnexpectedArguments;
...
class UnexpectedArgumentsTest extends TestCase
{
    ...
    public static function check(
        #[Stub('Harness_Query_Fibers_UnexpectedArguments')]WorkflowStubInterface $stub,
    ): void {
...
class FeatureWorkflow
{
    ...
    #[WorkflowMethod('Harness_Query_Fibers_UnexpectedArguments')]
    public function run()
    {
