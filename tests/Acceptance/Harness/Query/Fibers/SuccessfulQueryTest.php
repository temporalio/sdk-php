...
namespace Temporal\Tests\Acceptance\Harness\Query\Fibers\SuccessfulQuery;
...
{
    #[Test]
    public static function check(#[Stub('Harness_Query_Fibers_SuccessfulQuery')]WorkflowStubInterface $stub): void
    {
...
class FeatureWorkflow
{
    ...
    #[WorkflowMethod('Harness_Query_Fibers_SuccessfulQuery')]
    public function run()
    {
