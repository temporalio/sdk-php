...
namespace Temporal\Tests\Acceptance\Harness\Query\Fibers\TimeoutDueToNoActiveWorkers;
...
class TimeoutDueToNoActiveWorkersTest extends TestCase
{
    ...
    public static function check(
        #[Client(timeout: 10)]
        #[Stub('Harness_Query_Fibers_TimeoutDueToNoActiveWorkers')]
...
class FeatureWorkflow
{
    ...
    #[WorkflowMethod('Harness_Query_Fibers_TimeoutDueToNoActiveWorkers')]
    public function run()
    {
