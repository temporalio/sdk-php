...
namespace Temporal\Tests\Acceptance\Harness\Query\Fibers\UnexpectedQueryTypeName;
...
class UnexpectedQueryTypeNameTest extends TestCase
{
    ...
    public static function check(
        #[Stub('Harness_Query_Fibers_UnexpectedQueryTypeName')]WorkflowStubInterface $stub,
    ): void {
        try {
...
class FeatureWorkflow
{
    ...
    #[WorkflowMethod('Harness_Query_Fibers_UnexpectedQueryTypeName')]
    public function run()
    {
