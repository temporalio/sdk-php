...
namespace Temporal\Tests\Acceptance\Harness\Query\Fibers\UnexpectedReturnType;
...
class UnexpectedReturnTypeTest extends TestCase
{
    ...
    public static function check(
        #[Stub('Harness_Query_Fibers_UnexpectedReturnType')]WorkflowStubInterface $stub,
    ): void {
        try {
...
class FeatureWorkflow
{
    ...
    #[WorkflowMethod('Harness_Query_Fibers_UnexpectedReturnType')]
    public function run()
    {
