...
namespace Temporal\Tests\Acceptance\Harness\Update\Fibers\BasicAsync;
...
class BasicAsyncTest extends TestCase
{
    ...
    public static function check(
        #[Stub('Harness_Update_Fibers_BasicAsync')]WorkflowStubInterface $stub,
    ): void {
        try {
...
class FeatureWorkflow
{
    ...
    #[WorkflowMethod('Harness_Update_Fibers_BasicAsync')]
    public function run()
    {
