...
namespace Temporal\Tests\Acceptance\Harness\Update\Fibers\NonDurableReject;
...
class NonDurableRejectTest extends TestCase
{
    ...
    public static function check(
        #[Stub('Harness_Update_Fibers_NonDurableReject')]WorkflowStubInterface $stub,
...
class FeatureWorkflow
{
    ...
    #[WorkflowMethod('Harness_Update_Fibers_NonDurableReject')]
    public function run()
    {
    ...
    #[\Temporal\Workflow\UpdateValidatorMethod('my_update')]
