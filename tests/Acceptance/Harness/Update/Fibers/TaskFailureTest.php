...
namespace Temporal\Tests\Acceptance\Harness\Update\Fibers\TaskFailure;
...
class TaskFailureTest extends TestCase
{
    ...
    public static function retryableException(
        #[Stub('Harness_Update_Fibers_TaskFailure')] WorkflowStubInterface $stub,
    ): void {
...
class FeatureWorkflow
{
    ...
    #[WorkflowMethod('Harness_Update_Fibers_TaskFailure')]
    public function run()
    {
    ...
    #[\Temporal\Workflow\UpdateMethod('throw_or_done')]
    public function throwOrDone(bool $doThrow): void
    {
        $this->done = true;
    }

    #[\Temporal\Workflow\UpdateValidatorMethod('throw_or_done')]
