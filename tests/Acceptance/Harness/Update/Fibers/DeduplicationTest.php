...
namespace Temporal\Tests\Acceptance\Harness\Update\Fibers\Deduplication;
...
class DeduplicationTest extends TestCase
{
    ...
    public function check(
        #[Stub('Harness_Update_Fibers_Deduplication')]WorkflowStubInterface $stub,
...
class FeatureWorkflow
{
    ...
    #[WorkflowMethod('Harness_Update_Fibers_Deduplication')]
    public function run()
    {
