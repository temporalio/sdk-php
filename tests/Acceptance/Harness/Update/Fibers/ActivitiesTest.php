...
namespace Temporal\Tests\Acceptance\Harness\Update\Fibers\Activities;
...
class ActivitiesTest extends TestCase
{
    ...
    public static function check(
        #[Stub('Harness_Update_Fibers_Activities')]WorkflowStubInterface $stub,
    ): void {
...
class FeatureWorkflow
{
    ...
    #[WorkflowMethod('Harness_Update_Fibers_Activities')]
    public function run()
    {
