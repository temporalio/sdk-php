...
namespace Temporal\Tests\Acceptance\Harness\WorkflowUpdate\Fibers\Context;
...
class ContextTest extends TestCase
{
    ...
    public static function check(
        #[Stub('Harness_WorkflowUpdate_Fibers_Context')]WorkflowStubInterface $stub,
    ): void {
...
class FeatureWorkflow
{
    ...
    #[WorkflowMethod('Harness_WorkflowUpdate_Fibers_Context')]
    public function run()
    {
    ...
    #[\Temporal\Workflow\UpdateMethod('my_update2')]
