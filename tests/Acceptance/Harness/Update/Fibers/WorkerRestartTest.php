...
namespace Temporal\Tests\Acceptance\Harness\Update\Fibers\WorkerRestart;
...
class WorkerRestartTest extends TestCase
{
    ...
    public static function check(
        #[Stub('Harness_Update_Fibers_WorkerRestart')]WorkflowStubInterface $stub,
...
class FeatureWorkflow
{
    ...
    #[WorkflowMethod('Harness_Update_Fibers_WorkerRestart')]
    public function run()
    {
    ...
    #[\Temporal\Workflow\UpdateMethod('do_activities')]
