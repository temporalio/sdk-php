...
namespace Temporal\Tests\Acceptance\Harness\Update\Fibers\ClientInterceptor;
...
class ClientInterceptorTest extends TestCase
{
    ...
    public static function check(
        #[Stub('Harness_Update_Fibers_ClientInterceptor')]
...
class FeatureWorkflow
{
    ...
    #[WorkflowMethod('Harness_Update_Fibers_ClientInterceptor')]
    public function run()
    {
