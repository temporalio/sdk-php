...
namespace Temporal\Tests\Acceptance\Harness\Update\Fibers\AsyncAccepted;
...
class AsyncAcceptTest extends TestCase
{
    ...
    public function check(
        #[Stub('Harness_Update_Fibers_AsyncAccepted')]WorkflowStubInterface $stub,
    ): void {
...
class FeatureWorkflow
{
    ...
    #[WorkflowMethod('Harness_Update_Fibers_AsyncAccepted')]
    public function run()
    {
    ...
    #[\Temporal\Workflow\SignalMethod('finish')]
    public function finish()
    {
        $this->done = true;
    }

    #[\Temporal\Workflow\SignalMethod('unblock')]
