...
namespace Temporal\Tests\Acceptance\Harness\ChildWorkflow\Fibers\Signal;
...
{
    #[Test]
    public static function check(#[Stub('Harness_ChildWorkflow_Fibers_Signal')]WorkflowStubInterface $stub): void
    {
...
class ChildWorkflow
{
    ...
    #[WorkflowMethod('Harness_ChildWorkflow_Fibers_Signal_Child')]
    public function run()
    {
