...
namespace Temporal\Tests\Acceptance\Harness\ChildWorkflow\Fibers\CancelAbandon;
...
class CancelAbandonTest extends TestCase
{
    ...
    public static function childWorkflowInMainScope(
        #[Stub('Harness_ChildWorkflow_Fibers_CancelAbandon_MainScope', args: ['test 42'])]
    ...
    public static function childWorkflowInInnerScopeCancel(
        #[Stub('Harness_ChildWorkflow_Fibers_CancelAbandon_InnerScopeCancel', args: ['baz'])]
        WorkflowStubInterface $stub,
        WorkflowClientInterface $client,
    ): void {
    ...
    public static function childWorkflowInClosingInnerScope(
        #[Stub('Harness_ChildWorkflow_Fibers_CancelAbandon_InnerScopeCancel', args: ['foo bar'])]
        WorkflowStubInterface $stub,
        WorkflowClientInterface $client,
    ): void {
...
{
    #[WorkflowMethod('Harness_ChildWorkflow_Fibers_CancelAbandon_MainScope')]
...
class ChildWorkflow
{
    ...
    #[WorkflowMethod('Harness_ChildWorkflow_Fibers_CancelAbandon_Child')]
    public function run(string $input)
    {
    ...
    #[\Temporal\Workflow\SignalMethod('exit')]
