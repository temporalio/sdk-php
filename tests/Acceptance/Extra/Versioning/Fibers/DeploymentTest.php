...
namespace Temporal\Tests\Acceptance\Extra\Versioning\Fibers\Deployment;
...
class DeploymentTest extends TestCase
{
    ...
    public function defaultBehaviorAuto(
        ...
        $behavior = self::executeWorkflow(
            ...
            $feature,
            /** @see DefaultWorkflow */
            'Extra_Versioning_Fibers_Deployment_Default',
            WorkflowOptions::new(),
        );
    ...
    public function customBehaviorPinned(
        ...
        self::executeWorkflow(
            ...
            $feature,
            /** @see PinnedWorkflow */
            'Extra_Versioning_Fibers_Deployment_Pinned',
            ...
            postAction: static function (VersioningBehavior $behavior) use ($client, $id): void {
                ...
                $attributes = $client->newUntypedRunningWorkflowStub($id, workflowType: 'Extra_Versioning_Fibers_Deployment_Pinned')
                    ->describe()
                    ->info
                    ->searchAttributes
                    ->getValues();
...
{
    #[WorkflowMethod(name: "Extra_Versioning_Fibers_Deployment_Default")]
...
{
    #[WorkflowMethod(name: "Extra_Versioning_Fibers_Deployment_Pinned")]
