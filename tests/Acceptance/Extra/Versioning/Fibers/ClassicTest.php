...
namespace Temporal\Tests\Acceptance\Extra\Versioning\Fibers\Classic;
...
class ClassicTest extends TestCase
{
    ...
    public function replayDifferentVersions(
        #[Stub(
            type: 'Extra_Versioning_Fibers_Classic',
        ...
        $replayer->replayFromJSON('Extra_Versioning_Fibers_Classic', __DIR__ . '/Classic/Versioning-default.json');
        $replayer->replayFromJSON('Extra_Versioning_Fibers_Classic', __DIR__ . '/Classic/Versioning-v1.json');
...
#[ActivityInterface(prefix: 'Extra_Versioning_Fibers_Classic.')]
class TestActivity
{
    #[ActivityMethod]
