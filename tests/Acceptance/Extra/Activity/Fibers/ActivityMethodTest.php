...
namespace Temporal\Tests\Acceptance\Extra\Activity\Fibers\ActivityMethod;
...
class ActivityMethodTest extends TestCase
{
    public function testMethodWithAttribute(
        #[Stub('Extra_Activity_Fibers_ActivityMethod', args: ['method' => 'withAttribute'])]
    ...
    public function testMethodWithoutAttribute(
        #[Stub('Extra_Activity_Fibers_ActivityMethod', args: ['method' => 'withoutAttribute'])]
        WorkflowStubInterface $stub,
    ): void {
        $result = $stub->getResult('array');
    ...
    public function testMagicMethodIsIgnored(
        #[Stub('Extra_Activity_Fibers_ActivityMethod', args: ['method' => '__invoke'])]
        WorkflowStubInterface $stub,
    ): void {
...
#[Activity\ActivityInterface(prefix: 'Extra_Activity_Fibers_ActivityMethod.')]
class TestActivity
{
    #[ActivityMethod]
