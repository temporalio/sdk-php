...
namespace Temporal\Tests\Acceptance\Extra\Activity\Fibers\ActivityPaused;
...
class ActivityPausedTest extends TestCase
{
    ...
    public function simplePause(
        #[Stub('Extra_Activity_Fibers_ActivityPaused', executionTimeout: '200 seconds')] WorkflowStubInterface $stub,
        ...
        $serviceClient->PauseActivity(
            (new PauseActivityRequest())
                ...
                ->setType('Extra_Activity_Fibers_ActivityPaused.sleep')
                ->setExecution(
...
class TestWorkflow
{
    #[WorkflowMethod(name: "Extra_Activity_Fibers_ActivityPaused")]
...
#[Activity\ActivityInterface(prefix: 'Extra_Activity_Fibers_ActivityPaused.')]
class TestActivity
{
