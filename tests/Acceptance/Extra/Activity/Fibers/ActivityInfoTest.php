...
namespace Temporal\Tests\Acceptance\Extra\Activity\Fibers\ActivityInfo;
...
class ActivityInfoTest extends TestCase
{
    ...
    public static function retryPolicy(
        #[Stub('Extra_Activity_Fibers_ActivityInfo', args: [TestWorkflow::ARG_RETRY_OPTIONS])]
...
class TestWorkflow
{
    ...
    #[WorkflowMethod(name: "Extra_Activity_Fibers_ActivityInfo")]
    ...
    private function getRetryOptions(): object
    {
...
#[Activity\ActivityInterface(prefix: 'Extra_Activity_Fibers_ActivityInfo.')]
class TestActivity
{
