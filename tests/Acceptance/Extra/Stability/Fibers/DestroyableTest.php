...
namespace Temporal\Tests\Acceptance\Extra\Stability\Fibers\Destroyable;
...
class DestroyableTest extends TestCase
{
    ...
    public function destroyOnFinish(
        #[Stub('Extra_Stability_Fibers_Destroyable')] WorkflowStubInterface $stub,
        ClientLogger $logger,
    ): void {
        $stub->getResult();
...
class TestWorkflow implements Destroyable
{
    ...
    #[WorkflowMethod('Extra_Stability_Fibers_Destroyable')]
