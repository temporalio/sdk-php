...
namespace Temporal\Tests\Acceptance\Extra\Stability\Fibers\DynamicSignalWithPromises;
...
class DynamicSignalWithPromisesTest extends TestCase
{
    ...
    public function steps(
        #[Stub('Extra_Stability_Fibers_DynamicSignalWithPromises')] WorkflowStubInterface $stub,
    ): void {
