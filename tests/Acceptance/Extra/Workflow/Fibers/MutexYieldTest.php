...
namespace Temporal\Tests\Acceptance\Extra\Workflow\Fibers\MutexYield;
...
class MutexYieldTest extends TestCase
{
    ...
    public function runWithUnblockUnblock(
        #[Stub('Extra_Workflow_Fibers_MutexYield')]
...
class TestWorkflow
{
    ...
    #[WorkflowMethod(name: "Extra_Workflow_Fibers_MutexYield")]
