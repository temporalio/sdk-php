...
namespace Temporal\Tests\Acceptance\Extra\Workflow\Fibers\AllHandlersFinished;
...
class AllHandlersFinishedTest extends TestCase
{
    ...
    public function updateHandlersWithOneCall(
        #[Stub('Extra_Workflow_Fibers_AllHandlersFinished')] WorkflowStubInterface $stub,
    ): void {
    ...
    public function warnUnfinishedSignals(
        ...
        self::assertStringContainsString(
            'Workflow `Extra_Workflow_Fibers_AllHandlersFinished` finished while signal handlers are still running.',
            $record->message,
        );
        ...
        self::assertSame('Extra_Workflow_Fibers_AllHandlersFinished', $record->context['workflow_type']);
    ...
    public function warnUnfinishedUpdates(
        ...
        $record = $records[0];
        self::assertStringContainsString(
            'Workflow `Extra_Workflow_Fibers_AllHandlersFinished` finished while update handlers are still running.',
            $record->message,
        );
    ...
    public function warnUnfinishedOnCancel(
        ...
        self::assertStringContainsString(
            'Workflow `Extra_Workflow_Fibers_AllHandlersFinished` cancelled while update handlers are still running.',
            $records[0]->message,
        );
        self::assertStringContainsString(
            'Workflow `Extra_Workflow_Fibers_AllHandlersFinished` cancelled while signal handlers are still running.',
            $records[1]->message,
        );
    }
}
...
class TestWorkflow
{
    ...
    #[WorkflowMethod(name: "Extra_Workflow_Fibers_AllHandlersFinished")]
     ...
     */
    #[\Temporal\Workflow\UpdateMethod(name: 'await')]
     ...
     */
    #[\Temporal\Workflow\UpdateMethod(name: 'resolve', unfinishedPolicy: \Temporal\Workflow\HandlerUnfinishedPolicy::Abandon)]
     ...
     * @param non-empty-string $name
     */
    #[\Temporal\Workflow\SignalMethod(name: 'await')]
     ...
     * @param non-empty-string $name
     */
    #[\Temporal\Workflow\SignalMethod(name: 'resolve', unfinishedPolicy: \Temporal\Workflow\HandlerUnfinishedPolicy::Abandon)]
