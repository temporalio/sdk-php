...
namespace Temporal\Tests\Acceptance\Extra\Workflow\Fibers\InitMethod;
...
class InitMethodTest extends TestCase
{
    ...
    public function simpleCase(
        #[Stub(
            type: 'Extra_Workflow_Fibers_InitMethod',
    ...
    public function emptyConstructor(
        #[Stub(
            type: 'Extra_Workflow_Fibers_InitMethod__empty_constructor',
            args: [new Input('John Doe', 30)],
        )] WorkflowStubInterface $stub,
    ): void {
        $this->assertTrue($stub->getResult());
    ...
    public function differentConstructorParams(
        #[Stub(
            type: 'Extra_Workflow_Fibers_InitMethod__different_constructor_params',
...
class TestWorkflow
{
    ...
    #[WorkflowMethod(name: "Extra_Workflow_Fibers_InitMethod")]
...
class TestWorkflowEmptyConstructor
{
    ...
    #[WorkflowMethod(name: "Extra_Workflow_Fibers_InitMethod__empty_constructor")]
    public function handle(Input $input)
    {
        return $this->initInput === \func_get_args();
    }
...
class TestWorkflowDifferentConstructorParams
{
    ...
    #[WorkflowMethod(name: "Extra_Workflow_Fibers_InitMethod__different_constructor_params")]
    public function handle(Input $input)
    {
        return $this->initInput === \func_get_args();
    }
