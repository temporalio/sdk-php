...
namespace Temporal\Tests\Acceptance\Extra\Workflow\Fibers\Priority;
...
class TestWorkflow
{
    #[WorkflowMethod(name: "Extra_Workflow_Fibers_Priority")]
    public function handle(bool $runChild = false)
    {
        $activity = Workflow::executeActivity(
            'Extra_Workflow_Fibers_Priority.handler',
...
#[Activity\ActivityInterface(prefix: 'Extra_Workflow_Fibers_Priority.')]
class TestActivity
{
