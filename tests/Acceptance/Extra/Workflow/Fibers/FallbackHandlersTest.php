...
namespace Temporal\Tests\Acceptance\Extra\Workflow\Fibers\FallbackHandlers;
...
class FallbackHandlersTest extends TestCase
{
    ...
    public function fallbackQuery(
        #[Stub('Extra_Workflow_Fibers_FallbackHandlers')] WorkflowStubInterface $stub,
        ClientLogger $logger,
    ): void {
        try {
...
class TestWorkflow
{
    ...
    #[WorkflowMethod(name: "Extra_Workflow_Fibers_FallbackHandlers")]
    ...
    #[\Temporal\Workflow\UpdateMethod('register_query_fallback')]
    ...
    #[\Temporal\Workflow\UpdateMethod('register_signals_fallback')]
    ...
    #[\Temporal\Workflow\UpdateMethod('register_updates_fallback')]
