...
namespace Temporal\Tests\Acceptance\Extra\Workflow\Fibers\Metadata;
...
class MetadataTest extends TestCase
{
    ...
    public static function withoutDynamicHandlers(
        #[Stub('Extra_Workflow_Fibers_Metadata')] WorkflowStubInterface $stub,
    ): void {
    ...
    public static function withDynamicHandlers(
        #[Stub('Extra_Workflow_Fibers_Metadata', args: [true])]
...
class FeatureWorkflow
{
    ...
    #[WorkflowMethod('Extra_Workflow_Fibers_Metadata')]
