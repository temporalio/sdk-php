...
namespace Temporal\Tests\Acceptance\Extra\Workflow\Fibers\WorkflowInfo;
...
class WorkflowInfoTest extends TestCase
{
    ...
    public static function rootWorkflowExecution(
        #[Stub('Extra_Workflow_Fibers_WorkflowInfo', args: [[MainWorkflow::ARG_ROOT_EXECUTION]])]
    ...
    public static function retryOptions(
        #[Stub(
            'Extra_Workflow_Fibers_WorkflowInfo',
...
class MainWorkflow
{
    ...
    #[WorkflowMethod('Extra_Workflow_Fibers_WorkflowInfo')]
    public function run(array $actions)
    {
        ...
        return match ($action) {
            ...
            self::ARG_CONTINUE_AS_NEW => Workflow::continueAsNew('Extra_Workflow_Fibers_WorkflowInfo', args: [$actions]),
...
class ChildWorkflow
{
    #[WorkflowMethod('Extra_Workflow_Fibers_WorkflowInfo_Child')]
    public function run()
    {
...
{
    #[WorkflowMethod('Extra_Workflow_Fibers_WorkflowInfo_Child2')]
    public function run()
    {
