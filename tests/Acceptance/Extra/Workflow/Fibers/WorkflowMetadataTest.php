...
namespace Temporal\Tests\Acceptance\Extra\Workflow\Fibers\WorkflowMetadata;
...
class WorkflowMetadataTest extends TestCase
{
    ...
    public function metadataQuery(
        #[Stub('Extra_Workflow_Fibers_WorkflowMetadata', args: ["from test"])] WorkflowStubInterface $stub,
    ): void {
...
class TestWorkflow
{
    ...
    #[WorkflowMethod(name: "Extra_Workflow_Fibers_WorkflowMetadata")]
