...
namespace Temporal\Tests\Acceptance\Extra\Workflow\Fibers\SideEffect;
...
class SideEffectTest extends TestCase
{
    ...
    public static function currentTime(
        #[Stub('Extra_Workflow_Fibers_SideEffect')]
    ...
    public static function distinctSummariesPerSideEffect(
        #[Stub('Extra_Workflow_Fibers_SideEffect_Multi')]
        WorkflowStubInterface $stub,
        WorkflowClientInterface $client,
        DataConverterInterface $dataConverter,
    ): void {
    ...
    public static function noSummaryWhenOptionsOmitted(
        #[Stub('Extra_Workflow_Fibers_SideEffect_NoOptions')]
        WorkflowStubInterface $stub,
        WorkflowClientInterface $client,
    ): void {
        $stub->getResult();
...
class MainWorkflow
{
    #[WorkflowMethod('Extra_Workflow_Fibers_SideEffect')]
    public function run()
    {
...
{
    #[WorkflowMethod('Extra_Workflow_Fibers_SideEffect_Multi')]
    public function run()
    {
        Workflow::sideEffect(
            static fn(): int => 1,
...
{
    #[WorkflowMethod('Extra_Workflow_Fibers_SideEffect_NoOptions')]
    public function run()
    {
