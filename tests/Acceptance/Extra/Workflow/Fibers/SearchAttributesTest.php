...
namespace Temporal\Tests\Acceptance\Extra\Workflow\Fibers\SearchAttributes;
...
class SearchAttributesTest extends TestCase
{
    ...
    public function testStartWithSearchAttributes(
        ...
        $stub = $client->newUntypedWorkflowStub(
            'Extra_Workflow_Fibers_SearchAttributes',
            WorkflowOptions::new()
...
class TestWorkflow
{
    ...
    #[WorkflowMethod(name: "Extra_Workflow_Fibers_SearchAttributes")]
