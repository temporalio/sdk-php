...
namespace Temporal\Tests\Acceptance\Extra\Workflow\Fibers\BuiltInPrefixedHandlers;
...
class BuiltInPrefixedHandlersTest extends TestCase
{
    ...
    public function denyBuiltInPrefixes(
        #[Stub('Extra_Workflow_Fibers_BuiltInPrefixedHandlers')] WorkflowStubInterface $stub,
    ): void {
        self::assertSame(
...
class TestWorkflow
{
    ...
    #[WorkflowMethod(name: "Extra_Workflow_Fibers_BuiltInPrefixedHandlers")]
    public function handle()
    {
        $this->onExit();
    }

    #[\Temporal\Workflow\UpdateMethod('register_query_with_prefix')]
    ...
    #[\Temporal\Workflow\UpdateMethod('register_signals_with_prefix')]
    ...
    #[\Temporal\Workflow\UpdateMethod('register_updates_with_prefix')]
