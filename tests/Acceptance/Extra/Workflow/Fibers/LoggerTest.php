...
namespace Temporal\Tests\Acceptance\Extra\Workflow\Fibers\Logger;
...
class TestWorkflow
{
    ...
    #[\Temporal\Workflow\SignalMethod(name: 'logFromSignal')]
    ...
    #[\Temporal\Workflow\SignalMethod(name: 'exit')]
    public function exit(): void
    {
        $this->exit = true;
    }

    #[\Temporal\Workflow\QueryMethod(name: 'logWithContext')]
    ...
    #[\Temporal\Workflow\UpdateMethod(name: 'logMultipleLevels')]
