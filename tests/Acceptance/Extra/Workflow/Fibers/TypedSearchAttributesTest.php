...
namespace Temporal\Tests\Acceptance\Extra\Workflow\Fibers\TypedSearchAttributes;
...
class TypedSearchAttributesTest extends TestCase
{
    ...
    public function testStartWithTypedSearchAttributes(
        ...
        $stub = $client->newUntypedWorkflowStub(
            'Extra_Workflow_Fibers_TypedSearchAttributes',
            WorkflowOptions::new()
...
class TestWorkflow
{
    ...
    #[WorkflowMethod(name: "Extra_Workflow_Fibers_TypedSearchAttributes")]
