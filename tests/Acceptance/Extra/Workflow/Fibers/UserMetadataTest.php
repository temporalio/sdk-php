...
namespace Temporal\Tests\Acceptance\Extra\Workflow\Fibers\UserMetadata;
...
class UserMetadataTest extends TestCase
{
    ...
    public function scheduleWorkflowMetadata(
        ...
        $schedule = $client->createSchedule(
            Schedule::new()
                ->withAction(
                    StartWorkflowAction::new('Extra_Workflow_Fibers_UserMetadata')
                        ->withTaskQueue($feature->taskQueue)
    ...
    public function timerMetadata(
        #[Stub('Extra_Workflow_Fibers_UserMetadata')]
...
class TestWorkflow
{
    ...
    public function executeActivity(string $summary)
    {
        ...
        return Workflow::executeActivity(
            'Extra_Workflow_Fibers_UserMetadata.execute',
    ...
    {
        /** @see TestLocalActivity::execute() */
        return Workflow::executeActivity(
            'Extra_Workflow_Fibers_UserMetadata.Local.execute',
...
#[ActivityInterface('Extra_Workflow_Fibers_UserMetadata.')]
class TestActivity
{
...
#[ActivityInterface('Extra_Workflow_Fibers_UserMetadata.Local.')]
