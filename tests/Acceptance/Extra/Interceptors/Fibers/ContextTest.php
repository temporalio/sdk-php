...
namespace Temporal\Tests\Acceptance\Extra\Interceptors\Fibers\Context;
...
class ContextTest extends TestCase
{
    ...
    public function instanceInContext(
        #[Stub('Extra_Interceptors_Fibers_Context')] WorkflowStubInterface $stub,
    ): void {
        $stub->signal('exit');
    ...
    public function failInConstructor(
        #[Stub('Extra_Interceptors_Fibers_Context_Failing')] WorkflowStubInterface $stub,
    ): void {
        try {
    ...
    public function failInInterceptorExecute(
        #[Stub('Extra_Interceptors_Fibers_Context_Failing', args: ['exception-in-execute'])] WorkflowStubInterface $stub,
    ): void {
        try {
            $stub->getResult('array');
            $this->fail('An exception should have been thrown.');
    ...
    public function readonlyContextInConstructor(
        #[Stub('Extra_Interceptors_Fibers_Context_Readonly')] WorkflowStubInterface $stub,
    ): void {
...
class TestFailingWorkflow
{
    ...
    #[WorkflowMethod(name: "Extra_Interceptors_Fibers_Context_Failing")]
...
class TestReadonlyConstructorWorkflow
{
    ...
    #[WorkflowMethod(name: "Extra_Interceptors_Fibers_Context_Readonly")]
...
#[Activity\ActivityInterface(prefix: 'Extra_Interceptors_Fibers_Context.')]
class TestActivity
{
