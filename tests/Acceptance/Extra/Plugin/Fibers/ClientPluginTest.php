...
namespace Temporal\Tests\Acceptance\Extra\Plugin\Fibers\ClientPlugin;
...
class ClientPluginTest extends TestCase
{
    ...
    public function pluginInterceptorModifiesArguments(
        ...
        $stub = $pluginClient->newUntypedWorkflowStub(
            'Extra_Plugin_Fibers_ClientPlugin',
    ...
    public function duplicatePluginThrowsException(
        ...
        $this->expectExceptionMessage('Duplicate plugin "prefix-plugin-fibers"');
    ...
    public function pluginAppliedViaWorkerAttribute(
        #[Stub('Extra_Plugin_Fibers_ClientPlugin', args: ['world'])]
...
class TestWorkflow
{
    #[WorkflowMethod(name: 'Extra_Plugin_Fibers_ClientPlugin')]
