...
final class TaskQueueResolver
{
    ...
    private const SHARED_QUEUE_EXCLUSIONS = [
        ...
        \Temporal\Tests\Acceptance\Extra\Workflow\Fibers\WorkflowA\WorkflowATest::class,
        \Temporal\Tests\Acceptance\Extra\Workflow\Fibers\WorkflowB\WorkflowBTest::class,
        \Temporal\Tests\Acceptance\Harness\Activity\RetryOnError\RetryOnErrorTest::class,
        \Temporal\Tests\Acceptance\Harness\Activity\Fibers\RetryOnError\RetryOnErrorTest::class,
        \Temporal\Tests\Acceptance\Harness\Update\Self\SelfTest::class,
        \Temporal\Tests\Acceptance\Harness\Update\Fibers\Self\SelfTest::class,
        \Temporal\Tests\Acceptance\Harness\Update\Activities\ActivitiesTest::class,
        \Temporal\Tests\Acceptance\Harness\Update\Fibers\Activities\ActivitiesTest::class,
        \Temporal\Tests\Acceptance\Harness\Signal\Activities\ActivitiesTest::class,
        \Temporal\Tests\Acceptance\Harness\Signal\Fibers\Activities\ActivitiesTest::class,
