...
/**
 * The maximum time that a workflow execution can be running including retries
 * and continue-as-new.
 *
...
final class WorkflowExecutionTimeout
{
    ...
    public function __construct(mixed $timeout)
    {
        ...
        if ($this->interval->totalMicroseconds < 0) {
            throw new \InvalidArgumentException('WorkflowExecutionTimeout must be non-negative.');
        }
    }
}
