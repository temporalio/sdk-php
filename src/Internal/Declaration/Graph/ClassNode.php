...
final class ClassNode implements NodeInterface
{
     ...
     * @return \Traversable<int, \Traversable<ClassNode, \ReflectionMethod>>
     * @throws \ReflectionException
     */
     ...
     * @return list<array{ClassNode, \ReflectionMethod}>
     * @throws \ReflectionException
     */
    ...
    /**
     * @param array<array{ClassNode, \ReflectionMethod}> $boxed
